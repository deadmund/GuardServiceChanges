...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            // Added by EdNovak for guard service
            try{
                Slog.i(TAG, "GuardService");
                ServiceManager.addService("GuardService", new GuardService(context));
            } catch (Throwable e){
            	reportWtf("starting GuardService", e);
                Log.d(TAG, "Failed starting GuardService", e);
            }
            //
