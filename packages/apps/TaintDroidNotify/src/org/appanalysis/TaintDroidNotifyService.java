...
public class TaintDroidNotifyService extends Service {
	...
	// yytang
	ttable.put(new Integer(0x00010000), "Speaker");
	ttable.put(new Integer(0x00020000), "Vibration");
	ttable.put(new Integer(0x00040000), "Flash");
	ttable.put(new Integer(0x00080000), "User");
    }
